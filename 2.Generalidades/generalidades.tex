...
\begin{itemize}
         ...
         \begin{figure}[htb]
            ...
            \caption{Croquis de ubicación.} \label{fig:croquis}
         \end{figure}
         \item \textbf{Teléfono:} 
         \item \textbf{Dirección de correo electrónico:} 
         \item Giro, misión, visión valores y políticas de calidad:
...
\begin{itemize}
         ...
         \item \textbf{Descripción del  área en que se participó:} 
    \end{itemize}
